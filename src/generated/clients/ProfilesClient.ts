...
export class ProfilesClient extends BaseEndpointClient {
   ...
   */
  async listProfilesEndpointProfilesGet({ id, limit, nickname, skip, userId }: { id?: string | null; limit?: number | null; nickname?: string | null; skip?: number | null; userId?: string | null }): Promise<ProfileList[]> {
